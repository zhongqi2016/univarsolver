...
def test_last(df, eps, repeat):
    ...
    for num in range(0, repeat):
        ...
        for test in df.itertuples():
            ...
            time_Cas = (T2 - T1)
            it_list_row[0] = Cas
            time_list_row[0] += time_Cas / repeat
            ...
            time_PC_N = (T2 - T1)
            it_list_row[1] = PC_N
            time_list_row[1] += time_PC_N / repeat
            ...
            time_PI_N = (T2 - T1)
            it_list_row[2] = PI_N
            time_list_row[2] += time_PI_N / repeat
            ...
            time_QC_N = (T2 - T1)
            it_list_row[3] = QC_N
            time_list_row[3] += time_QC_N / repeat
            ...
            time_QI_N = (T2 - T1)
            it_list_row[4] = QI_N
            time_list_row[4] += time_QI_N / repeat
            ...
            time_PC_R = (T2 - T1)
            it_list_row[5] = PC_R
            time_list_row[5] += time_PC_R / repeat
            ...
            time_PI_R = (T2 - T1)
            it_list_row[6] = PI_R
            time_list_row[6] += time_PI_R / repeat
            ...
            time_QC_R = (T2 - T1)
            it_list_row[7] = QC_R
            time_list_row[7] += time_QC_R / repeat
            ...
            time_QI_R = (T2 - T1)
            it_list_row[8] = QI_R
            time_list_row[8] += time_QI_R / repeat
